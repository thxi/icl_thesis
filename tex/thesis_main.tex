...
\begin{remark}
    In \cite{1706.03762}, authors additionally scaled the weights $\alpha_i$ by the dimension of the key vectors $d_k$.
...
In \cite{2006.16236}, authors propose a new attention mechanism called \textbf{linear attention}.
